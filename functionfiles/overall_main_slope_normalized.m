...
%% Get data
dir_name = setup_dir();
[easy_tp_rt,easy_tp_p] = overall_main_slope('easy',2,1,false);
[easy_ta_rt,easy_ta_p] = overall_main_slope('easy',2,2,false);
[difficult_tp_rt,difficult_tp_p] = overall_main_slope('difficult',2,1,false);
[difficult_ta_rt,difficult_ta_p] = overall_main_slope('difficult',2,2,false);
...
errorbar(100:30:460,easy_tp_rt*1000,s_easy_tp_rt*1000,'ro-','LineWidth',1.5,'MarkerFaceColor',[1 1 1],'MarkerSize',8,'Color',easyclrTP)
errorbar(100:30:460,easy_ta_rt*1000,s_easy_ta_rt*1000,'ro-','LineWidth',1.5,'MarkerFaceColor',[1 1 1],'MarkerSize',8,'Color',easyclrTA)
...
errorbar(100:30:460,difficult_tp_rt*1000,s_difficult_tp_rt*1000,'ro-','LineWidth',1.5,'MarkerFaceColor',[1 1 1],'MarkerSize',8,'Color',difficultclrTP)
errorbar(100:30:460,difficult_ta_rt*1000,s_difficult_ta_rt*1000,'ro-','LineWidth',1.5,'MarkerFaceColor',[1 1 1],'MarkerSize',8,'Color',difficultclrTA)
