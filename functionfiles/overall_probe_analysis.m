...
s_pair_p1=std(pair_p1,[],2)/sqrt(numObs);
s_pair_p2=std(pair_p2,[],2)/sqrt(numObs);
...
if printFg == true
    ...
    for i = 1:3
        ...
        % plot(100:30:460,t1,s_t1,'ro-','LineWidth',2,'MarkerFaceColor',[1 1 1],'MarkerSize',8,'Color',[.96 .37 .15])
        % plot(100:30:460,t2,s_t2,'go-','LineWidth',2,'MarkerFaceColor',[1 1 1],'MarkerSize',8,'Color',[.13 .7 .15])   
