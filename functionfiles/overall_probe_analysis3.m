...
namefig=sprintf('%s', ['C:\Users\Alice\Documents\MATLAB\data\figures\' condition '_3rawProbs']);
...
namefig=sprintf('%s', ['C:\Users\Alice\Documents\MATLAB\data\figures\' condition '_3p1p2']);
print ('-djpeg', '-r500',namefig);
...
namefig=sprintf('%s', ['C:\Users\Alice\Documents\MATLAB\data\figures\' condition '_3p1p2PAIR1']);
print ('-djpeg', '-r500',namefig);
...
namefig=sprintf('%s', ['C:\Users\Alice\Documents\MATLAB\data\figures\' condition '_3p1p2PAIR2']);
print ('-djpeg', '-r500',namefig);  
...
namefig=sprintf('%s', ['C:\Users\Alice\Documents\MATLAB\data\figures\' condition '_3p1p2HemiDiagS']);
print ('-djpeg', '-r500',namefig);
...
namefig=sprintf('%s', ['C:\Users\Alice\Documents\MATLAB\data\figures\' condition '_3p1p2HemiDiagD']);
print ('-djpeg', '-r500',namefig);
end
