...
dir_name = setup_dir();
if expN == 1
    files = dir([dir_name '\', obs, '\main_', task]);  
elseif expN == 2
    files = dir([dir_name '\', obs, '\target present or absent\main_', task]);  
end
...
if printFg && ~isempty(Mpb)
    ...
    namefig=sprintf('%s', strrep([dir_name '\' obs '\' saveFileLoc '_rawProbsG' saveFileName],'\',filesep));
    ...
    namefig=sprintf('%s', strrep([dir_name '\' obs '\' saveFileLoc '_p1p2G' saveFileName],'\',filesep));
    print ('-djpeg', '-r500',namefig); 
    ...
    namefig=sprintf('%s', strrep([dir_name '\' obs '\' saveFileLoc '_p1p2PAIR1G' saveFileName],'\',filesep));
    print ('-djpeg', '-r500',namefig);
    ...
    namefig=sprintf('%s', strrep([dir_name '\' obs '\' saveFileLoc '_p1p2PAIR2G' saveFileName],'\',filesep));
    print ('-djpeg', '-r500',namefig);     
    ...
    namefig=sprintf('%s', strrep([dir_name '\' obs '\' saveFileLoc '_p1p2HemiDiagSG' saveFileName],'\',filesep));
    print ('-djpeg', '-r500',namefig);
    ...
    namefig=sprintf('%s', strrep(['\' obs '\' saveFileLoc '_p1p2HemiDiagDG' saveFileName],'\',filesep));
    print ('-djpeg', '-r500',namefig);
end
