...
namefig=sprintf('%s', 'C:\Users\Alice\Documents\MATLAB\data\figures\target present or absent\performance fields\Feature_Discrimination');
print ('-djpeg', '-r500',namefig);

figure; hold on;
radarPlot(easy_p_detect,'-o','LineWidth',1.6,'MarkerFaceColor',[1 1 1],'MarkerSize',9);
title('Feature Detection','FontSize',15)
namefig=sprintf('%s', 'C:\Users\Alice\Documents\MATLAB\data\figures\target present or absent\performance fields\Feature_Detection');
print ('-djpeg', '-r500',namefig);

figure; hold on;
radarPlot(easy_p_probe,'-o','LineWidth',1.6,'MarkerFaceColor',[1 1 1],'MarkerSize',9);
title('Feature Probe Performance','FontSize',15)
namefig=sprintf('%s', 'C:\Users\Alice\Documents\MATLAB\data\figures\target present or absent\performance fields\Feature_ProbePerf');
print ('-djpeg', '-r500',namefig);
...
namefig=sprintf('%s', 'C:\Users\Alice\Documents\MATLAB\data\figures\target present or absent\performance fields\Difficult_Discrimination');
print ('-djpeg', '-r500',namefig);

figure; hold on;
radarPlot(difficult_p_detect,'-o','LineWidth',1.6,'MarkerFaceColor',[1 1 1],'MarkerSize',9);
title('Conjunction Detection','FontSize',15)
namefig=sprintf('%s', 'C:\Users\Alice\Documents\MATLAB\data\figures\target present or absent\performance fields\Difficult_Detection');
print ('-djpeg', '-r500',namefig);
...
namefig=sprintf('%s', 'C:\Users\Alice\Documents\MATLAB\data\figures\target present or absent\performance fields\Difficult_ProbePerf');
print ('-djpeg', '-r500',namefig);
...
namefig=sprintf('%s', 'C:\Users\Alice\Documents\MATLAB\data\figures\target present or absent\performance fields\DiscriminationAvg');
print ('-djpeg', '-r500',namefig);
...
namefig=sprintf('%s', 'C:\Users\Alice\Documents\MATLAB\data\figures\target present or absent\performance fields\DetectionAvg');
print ('-djpeg', '-r500',namefig);
...
namefig=sprintf('%s', 'C:\Users\Alice\Documents\MATLAB\data\figures\target present or absent\performance fields\ProbePerfAvg');
print ('-djpeg', '-r500',namefig);
end
